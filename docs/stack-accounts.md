...
These accounts are required for JupyterLab image installation and configuration

## JupyterLab

* JupyterLab administrator username: `admin`
* JupyterLab administrator password: stored in the file of your server */credentials/password.txt*
